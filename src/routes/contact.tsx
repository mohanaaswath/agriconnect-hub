  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 grid md:grid-cols-2 gap-10">
      ...
      <form onSubmit={submit} className="glass rounded-2xl p-6 space-y-4">
        ...
        <button
          disabled={loading}
          className="w-full inline-flex justify-center items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-primary to-[color:var(--dark-gold)] text-primary-foreground font-medium shadow-glow disabled:opacity-50"
        >
