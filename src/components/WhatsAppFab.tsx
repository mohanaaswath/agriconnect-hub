...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-30 w-14 h-14 rounded-full bg-[oklch(0.65_0.2_150)] text-primary-foreground shadow-glow flex items-center justify-center hover:scale-105 transition"
    >
