...
export const input = "w-full px-3 py-2 bg-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary";
...
export function ProductForm({ initial, onClose, onSave, saving }: { initial: Partial<Product>; onClose: () => void; onSave: (v: Partial<Product>) => void; saving: boolean }) {
...
export function LivestockForm({ initial, onClose, onSave, saving }: { initial: Partial<Livestock>; onClose: () => void; onSave: (v: Partial<Livestock>) => void; saving: boolean }) {
...
export function RealEstateForm({ initial, onClose, onSave, saving }: { initial: Partial<RealEstate>; onClose: () => void; onSave: (v: Partial<RealEstate>) => void; saving: boolean }) {
